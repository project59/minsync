...
import { Phone, FolderOpen, RefreshCw, Sun, Moon } from 'lucide-react'
...
export default function App() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <header className="flex items-center justify-between mb-8 border-b pb-4 dark:border-zinc-700">
